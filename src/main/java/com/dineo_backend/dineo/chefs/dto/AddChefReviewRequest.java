...
/**
 * DTO for adding a review to a chef
 */
public class AddChefReviewRequest {
    
    @NotNull(message = "L'identifiant du chef est obligatoire")
    private UUID chefId;
    ...
    // Default constructor
    public AddChefReviewRequest() {
    }
    
    // Constructor with all fields
    public AddChefReviewRequest(UUID chefId, String reviewText, Integer rate) {
        this.chefId = chefId;
